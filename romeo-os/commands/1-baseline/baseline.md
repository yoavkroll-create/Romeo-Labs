...
Ready-to-use prompts for external research tools (GPT Deep Research, Perplexity, Gemini). Follow the template in `romeo-os/prompts/research-prompt-template.md`.
...
**6a. DoD Evaluation:**
Read `romeo-os/quality/baseline-dod.md` and evaluate all 10 criteria against the deliverables.
...
**6b. Readiness Check:**
After DoD passes, run the readiness check from `romeo-os/quality/readiness-check.md` using the `baseline` criteria configuration. Present the structured result:
