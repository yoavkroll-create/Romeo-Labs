...
Using the 8-column format from `romeo-os/prompts/feature-list-template.md`:
...
1. Run DoD from `romeo-os/quality/initial-prd-dod.md`.
2. Run readiness check from `romeo-os/quality/readiness-check.md` using the `initial-prd` criteria configuration.
